...
class UpdateProgresView extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Informasi Kasus',
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Color(0xFF1E2452)),
                    ),
                    const SizedBox(height: 16),
                    _buildReadOnlyCard('ID Kasus', '#${controller.kasusId.substring(0, 8).toUpperCase()}'),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const Icon(Icons.calendar_month_outlined, color: Color(0xFF2A2E5E), size: 20),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: TextField(
                        controller: controller.judulController, // ✅ Menggunakan controller baru
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                disabledBackgroundColor: const Color(0xFF1E2452).withOpacity(0.5),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                              ),
                              child: isLoading
                                  ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                                  : const Text('Simpan Progres', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                            ),
                          ),
                          const SizedBox(height: 12),
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                side: BorderSide(color: isLoading ? Colors.grey : Colors.green, width: 1.5),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                              ),
                              child: Text(
                                'Simpan & Selesaikan Kasus',
                                style: TextStyle(color: isLoading ? Colors.grey : Colors.green, fontWeight: FontWeight.bold),
                              ),
                            ),
                          ),
                        ],
  ...
  void _konfirmasiSelesai() {
    Get.defaultDialog(
      title: 'Konfirmasi',
      middleText: 'Apakah Anda yakin ingin menyelesaikan kasus ini?\nStatus tidak dapat dikembalikan ke proses.',
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text('Update Progres', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w600)),
                    ],
                  ),
                ),
              ),
