...
import '../controllers/info_chat_warga_controller.dart';
import '../../../widgets/pdf_viewer_screen.dart';
import '../../../app/data/services/api_service.dart';

class InfoChatWargaView extends GetView<InfoChatWargaController> {
  const InfoChatWargaView({super.key});
  ...
  Widget build(BuildContext context) {
    Get.put(InfoChatWargaController());
  ...
  Widget _buildHeader(BuildContext context) {
    final String displayName = controller.namaKlien.value;
    final String displayRole = 'Pelapor / Klien';
    
    // Foto profil url
    final String rawPhotoUrl = controller.fotoPelapor.value;
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      const Column(
                        ...
                        children: [
                          Text('Info Klien', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        controller.alamatPelapor.value,
